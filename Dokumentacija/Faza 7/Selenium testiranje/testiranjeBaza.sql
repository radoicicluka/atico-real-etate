...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 19, 2023 at 01:05 PM
...
('novi', 'noviprofil@gmail.com', 'sifra123', 'Novi', 'Profil'),
...
INSERT INTO `obavestenje` (`idOba`, `korIme`, `tekst`, `datumVreme`) VALUES
(1, 'mrmonaco', 'Odobren nalog.', NULL),
(2, 'msc91', 'Odbijen zahtev za licitaciju.', NULL),
(3, 'lec16', 'Uspesna promena informacija naloga.', '2023-06-19 09:06:29'),
(4, 'familyGuy', 'Oglas sa id: 1 je stavljen na licitaciju.', '2023-06-19 12:39:05');
...
(75, 'lec16', 'milos', 'noviOglas', 'Stan u centru Vracara sa terasom', 55555, 'Baba Visnjina 33', 5, 45, 'Vračar', 'etazno', 0, 0, 'Beograd', 'Diamond'),
(76, 'lec16', 'stefa', 'noviOglas2', 'Stan u centru grada sa terasom', 55000, 'Baba Visnjina 33', 5, 45, 'Vračar', 'etazno', 0, 0, 'Beograd', 'Kosmopolis');
...
CREATE TABLE IF NOT EXISTS `zahtev_za_licitaciju` (
  `idZah` int NOT NULL AUTO_INCREMENT,
  `idO` int NOT NULL,
...
--
-- Dumping data for table `zahtev_za_licitaciju`
--

INSERT INTO `zahtev_za_licitaciju` (`idZah`, `idO`, `datum`, `cena`) VALUES
(70, 1, '2023-06-22 01:01:00', 50000);
...
--
-- Dumping data for table `zahtev_za_oglase`
--

INSERT INTO `zahtev_za_oglase` (`idZah`, `opis`, `idO`, `cena`, `naziv`) VALUES
(65, NULL, 75, NULL, NULL),
(71, NULL, 76, NULL, NULL);
...
(64, 'novi', NULL, NULL, NULL),
(66, 'lec16', 'charleslec@gmail.com', 'Charlesss', 'Leclerc'),
(67, 'mrmonaco', NULL, 'nikola', '1');
COMMIT;
